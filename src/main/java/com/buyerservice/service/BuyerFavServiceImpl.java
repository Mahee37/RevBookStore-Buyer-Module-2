...
//	    favorites.setFavoriteId(favoritesDTO.getFavoriteId());
	    ...
	    favorites.setDiecountPrice(favoritesDTO.getDiscountPrice()); 
	    ...
	    savedFavoritesDTO.setDiscountPrice(savedFavorite.getDiecountPrice());
...
//fecthing those Favorites To view Again
	public List<FavoritesDTO> getFavoritesByUserId(Long userId) {
        ...
        for (Favorites favorite : favorites) {
            ...
            dto.setDiscountPrice(favorite.getDiecountPrice());
