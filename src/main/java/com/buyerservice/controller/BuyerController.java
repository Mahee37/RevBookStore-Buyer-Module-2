...
//------------------------------------
	...
	public ResponseEntity<User> login(@PathVariable("email") String email, @PathVariable("password") String password) {
		...
		UserProjection userProjection = buyerService.login(email, password);
...
//	    public ResponseEntity<String> updateProduct(@PathVariable Long productId, @RequestBody Products product) {
//	        try {
...
//-----------------------------------BHANUU
		 ...
		 public ResponseEntity<String> submitreview(@RequestBody Review review) {
		     ...
		     try {
		         ...
		         int result = reviewService.submitreview(review);
		         ...
		         // Handle any errors and return an appropriate error message and status
